...
describe('Errors', () => {
  ...
  it('constructor errors', async () => {
    ...
    await assert.isRejected(iamap.create(devnull, { hashAlg: 'identity', bitWidth: 10, bucketSize: 16 }, new Uint8Array(2)))
    await assert.isFulfilled(iamap.create(devnull, { hashAlg: 'identity', bitWidth: 10, bucketSize: 16 }, new Uint8Array((2 ** 10) / 8)))
  })
})
