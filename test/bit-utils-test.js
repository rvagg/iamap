...
test('mask', (t) => {
  ...
  t.strictEqual(mask([0b10101010], 0, 5), 0b10101)
  t.strictEqual(mask([0b10000000], 0, 5), 0b10000)
  t.strictEqual(mask([0b00010000], 0, 5), 0b00010)
  t.strictEqual(mask([0b10000100, 0b10010000], 0, 9), 0b100001001)
  t.strictEqual(mask([0b10101010, 0b10101010], 0, 9), 0b101010101)
  t.strictEqual(mask([0b10000100, 0b10010000], 1, 5), 0b10010)
  t.strictEqual(mask([0b10101010, 0b10101010], 1, 5), 0b01010)
  t.strictEqual(mask([0b10000100, 0b10010000], 2, 5), 0b01000)
  t.strictEqual(mask([0b10101010, 0b10101010], 2, 5), 0b10101)
  t.strictEqual(mask([0b10000100, 0b10010000, 0b10000100, 0b10000100], 3, 5), 0b01000)
  t.strictEqual(mask([0b10101010, 0b10101010, 0b10101010, 0b10101010], 3, 5), 0b01010)
  t.strictEqual(mask([0b10000100, 0b10010000, 0b10000100, 0b10000100], 4, 5), 0b01001)
  t.strictEqual(mask([0b10101010, 0b10101010, 0b10101010, 0b10101010], 4, 5), 0b10101)
  t.done()
})
